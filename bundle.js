...
/* harmony import */ var _model_point__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./model-point */ "./src/model-point.js");
...
class API {
  ...
  getPoints() {
    return this._load({url: `points`})
      .then(API.toJSON)
      .then(_model_point__WEBPACK_IMPORTED_MODULE_0__["default"].parsePoints);
  }
...
/***/ "./src/components/abstract-point.js":
/*!******************************************!*\
  !*** ./src/components/abstract-point.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AbstractPoint; });
...
class AbstractPoint extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor({type, city, dates, price, offers, description, pictures, isFavorite}, destinationCities = []) {
    ...
    this._groupToType = _utils__WEBPACK_IMPORTED_MODULE_1__["groupToType"];
    this._preposition = Object(_utils__WEBPACK_IMPORTED_MODULE_1__["getPreposition"])(type);
...
class Day extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
    ...
    return `<li class="trip-days__item  day">
              <div class="day__info">
                <span class="day__counter">${this._dayNumber === undefined ? `` : this._dayNumber + 1}</span>
                 <time class="day__date" datetime="${this._date ? moment__WEBPACK_IMPORTED_MODULE_1___default()(this._date).format(`YYYY-MM-DD`) : ``}">
...
class DaysList extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
  }
...
/***/ "./src/components/message-no-points.js":
/*!*********************************************!*\
  !*** ./src/components/message-no-points.js ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MessageNoPoints; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");


class MessageNoPoints extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
  }
...
/* harmony import */ var _abstract_point__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./abstract-point */ "./src/components/abstract-point.js");



class NewPoint extends _abstract_point__WEBPACK_IMPORTED_MODULE_1__["default"] {
            ...
            <header class="event__header">
              ...
              <div class="event__field-group  event__field-group--time">
                ${Object.keys(this._dates).map((stage) => `<label class="visually-hidden" for="event-start-${stage}-1">${this._stageToPreposition[stage]}</label>
                  ...
                  value="${moment__WEBPACK_IMPORTED_MODULE_0___default()(this._dates[stage]).format(`DD.MM.YYYY HH:mm`)}">
                  `).join(` &mdash; `)}
              </div>
...
class PointEdit extends _abstract_point__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor({type, city, dates, price, offers, description, pictures, isFavorite}, destinationCities) {
...
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _abstract_point__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./abstract-point */ "./src/components/abstract-point.js");




class Point extends _abstract_point__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor({type, city, dates, price, offers, duration}) {
    super({type, city, dates, price, offers});
    this._duration = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["formatDuration"])(duration);
  }
              ...
              <div class="event__schedule">
                <p class="event__time">
                  ${Object.keys(this._dates).map((stage) => `<time class="event__${stage}-time"
                    datetime="${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._dates[stage]).format(`YYYY-MM-DDTHH:mm`)}">${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._dates[stage]).format(`HH:mm`)}</time>`).join(` &mdash; `)}
                </p>
...
class Stats extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
  }
...
/***/ "./src/controllers/abstract-point.js":
/*!*******************************************!*\
  !*** ./src/controllers/abstract-point.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AbstractPointController; });
...
/* harmony import */ var _components_offers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/offers */ "./src/components/offers.js");
/* harmony import */ var _components_destination__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/destination */ "./src/components/destination.js");
...
class AbstractPointController {
  constructor(container, data, onDataChange, onChangeView, Point) {
    ...
    this._offersComponent = new _components_offers__WEBPACK_IMPORTED_MODULE_3__["default"](data.offers);
    this._destinationComponent = new _components_destination__WEBPACK_IMPORTED_MODULE_4__["default"](data);
  ...
  _initializeCalendars() {
    flatpickr__WEBPACK_IMPORTED_MODULE_0___default()(this._pointEdit.getElement().querySelector(`input[name=event-start-time]`), {
      altInput: true,
      altFormat: `d.m.Y H:i`,
      [`time_24hr`]: true,
      enableTime: true,
    ...
    const calendarEnd = flatpickr__WEBPACK_IMPORTED_MODULE_0___default()(this._pointEdit.getElement().querySelector(`input[name=event-end-time]`), {
      altInput: true,
      altFormat: `d.m.Y H:i`,
      [`time_24hr`]: true,
      enableTime: true,
  ...
  _updateOffersForCurrentType(offers) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_5__["unrender"])(this._offersComponent.getElement());
  ...
  _updateDestinationForCurrentCity(destination) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_5__["unrender"])(this._destinationComponent.getElement());
  ...
  _createOffers(data) {
    this._offersComponent = new _components_offers__WEBPACK_IMPORTED_MODULE_3__["default"](data);
    Object(_utils__WEBPACK_IMPORTED_MODULE_5__["render"])(this._containerEventDetails, this._offersComponent.getElement(), _utils__WEBPACK_IMPORTED_MODULE_5__["Position"].AFTERBEGIN);
  }

  _createDestination(destination) {
    this._destinationComponent = new _components_destination__WEBPACK_IMPORTED_MODULE_4__["default"](destination);
    Object(_utils__WEBPACK_IMPORTED_MODULE_5__["render"])(this._containerEventDetails, this._destinationComponent.getElement(), _utils__WEBPACK_IMPORTED_MODULE_5__["Position"].BEFOREEND);
  }

  _changePointType(type) {
    this._pointEdit.getElement()
      .querySelector(`.event__type-output`)
      .textContent = `${type} ${Object(_utils__WEBPACK_IMPORTED_MODULE_5__["getPreposition"])(type)}`;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return NewPointController; });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ "./src/utils.js");
/* harmony import */ var _abstract_point__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./abstract-point */ "./src/controllers/abstract-point.js");
/* harmony import */ var _components_new_point__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/new-point */ "./src/components/new-point.js");
...
class NewPointController extends _abstract_point__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(container, data, onDataChange, onChangeView, removeNewPoint) {
    super(container, data, onDataChange, onChangeView, _components_new_point__WEBPACK_IMPORTED_MODULE_2__["default"]);
  ...
  _create() {
    ...
    this._pointEdit.getElement().querySelector(`.event__save-btn`)
      .addEventListener(`click`, (evt) => {
        ...
        this._onDataChange(_main__WEBPACK_IMPORTED_MODULE_3__["Action"].CREATE, this._data);
      });
    document.addEventListener(`keydown`, (evt) => this._onEscKeyDown(evt));
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._pointEdit.getElement(), _utils__WEBPACK_IMPORTED_MODULE_0__["Position"].AFTERBEGIN);
  }

  _onEscKeyDown(evt) {
    if (evt.key === _utils__WEBPACK_IMPORTED_MODULE_0__["Key"].ESCAPE || evt.key === _utils__WEBPACK_IMPORTED_MODULE_0__["Key"].ESCAPE_IE) {
      this._closeNewPoint();
    }
  }

  _closeNewPoint() {
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["unrender"])(this._pointEdit.getElement());
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PointListController; });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ "./src/utils.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_day__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/day */ "./src/components/day.js");
/* harmony import */ var _point__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./point */ "./src/controllers/point.js");
/* harmony import */ var _new_point__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./new-point */ "./src/controllers/new-point.js");
/* harmony import */ var _model_point__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../model-point */ "./src/model-point.js");
...
class PointListController {
  ...
  createNewPoint(container) {
    ...
    const localPoint = {
      ...
      [`base_price`]: 0,
      [`date_from`]: moment__WEBPACK_IMPORTED_MODULE_1___default()().format(),
      [`date_to`]: moment__WEBPACK_IMPORTED_MODULE_1___default()().add(1, `hour`).format(),
      [`destination`]: {
        name: ``,
        pictures: [],
        description: ``
    ...
    this._newPointController = new _new_point__WEBPACK_IMPORTED_MODULE_4__["default"](container, new _model_point__WEBPACK_IMPORTED_MODULE_5__["default"](localPoint), this._onDataChange, this._onChangeView, () => {
      this._newPointController = null;
    });
  ...
  _getUniqueDays() {
    this._uniqueDays = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getUniqueList"])(this._points.map((point) => moment__WEBPACK_IMPORTED_MODULE_1___default()(point.dates.start).format(`MMM DD YYYY`)));
  }

  _getPointsDays() {
    this._pointsDays = this._uniqueDays.map((day) => this._points.filter((point) => moment__WEBPACK_IMPORTED_MODULE_1___default()(point.dates.start).format(`MMM DD YYYY`) === day));
  }

  _createDay(points, date, dayNumber) {
    const day = new _components_day__WEBPACK_IMPORTED_MODULE_2__["default"](points.length, date, dayNumber);
    ...
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, day.getElement(), _utils__WEBPACK_IMPORTED_MODULE_0__["Position"].BEFOREEND);
  }

  _createPoint(container, data) {
    const pointController = new _point__WEBPACK_IMPORTED_MODULE_3__["default"](container, data, this._onDataChange, this._onChangeView);
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ "./src/utils.js");
/* harmony import */ var _components_point__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/point */ "./src/components/point.js");
/* harmony import */ var _components_point_edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/point-edit */ "./src/components/point-edit.js");
/* harmony import */ var _abstract_point__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./abstract-point */ "./src/controllers/abstract-point.js");
...
class PointController extends _abstract_point__WEBPACK_IMPORTED_MODULE_3__["default"] {
  constructor(container, data, onDataChange, onChangeView) {
    super(container, data, onDataChange, onChangeView, _components_point_edit__WEBPACK_IMPORTED_MODULE_2__["default"]);
    this._data = data;
    this._pointView = new _components_point__WEBPACK_IMPORTED_MODULE_1__["default"](data);
  ...
  _create() {
    if (this._data.offers.length) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_0__["render"])(this._containerEventDetails, this._offersComponent.getElement(), _utils__WEBPACK_IMPORTED_MODULE_0__["Position"].AFTERBEGIN);
    }

    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["render"])(this._containerEventDetails, this._destinationComponent.getElement(), _utils__WEBPACK_IMPORTED_MODULE_0__["Position"].BEFOREEND);
    ...
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._pointView.getElement(), _utils__WEBPACK_IMPORTED_MODULE_0__["Position"].AFTERBEGIN);
  }
  ...
  _onSubmit(newData) {
    ...
    this._onDataChange(_main__WEBPACK_IMPORTED_MODULE_4__["Action"].UPDATE, this._data);
  }
}
...
class StatsController {
  constructor(container) {
    this._container = container;
    this._stats = new _components_stats__WEBPACK_IMPORTED_MODULE_0__["default"]();
  ...
  init(points) {
    ...
    this._moneyChart = new chart_js__WEBPACK_IMPORTED_MODULE_1___default.a(this._moneyCtx, {
    ...
    this._transportChart = new chart_js__WEBPACK_IMPORTED_MODULE_1___default.a(this._transportCtx, {
      plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_2___default.a],
      type: `horizontalBar`,
      data: {
        datasets: [{
    ...
    this._timeChart = new chart_js__WEBPACK_IMPORTED_MODULE_1___default.a(this._timeCtx, {
      plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_2___default.a],
      type: `horizontalBar`,
      data: {
        datasets: [{
      ...
      options: {
        ...
        plugins: {
          datalabels: {
            ...
            align: `start`,
            formatter(value) {
              return value ? `${Object(_utils__WEBPACK_IMPORTED_MODULE_3__["formatDuration"])(value)} ` : ``;
            }
          }
        },
        title: {
  ...
  _create() {
    Object(_utils__WEBPACK_IMPORTED_MODULE_3__["render"])(this._container, this._stats.getElement(), _utils__WEBPACK_IMPORTED_MODULE_3__["Position"].BEFOREEND);
  }

  _structureData(data) {
    this._pointsTypes = data.map((point) => point.type);
    this._uniquePointTypes = Object(_utils__WEBPACK_IMPORTED_MODULE_3__["getUniqueList"])(this._pointsTypes);
    this._pointTypesTransfer = this._pointsTypes.filter((type) => _utils__WEBPACK_IMPORTED_MODULE_3__["groupToType"].transfer.includes(type));
    this._uniquePointTypesTransfer = Object(_utils__WEBPACK_IMPORTED_MODULE_3__["getUniqueList"])(this._pointTypesTransfer);
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ "./src/utils.js");
/* harmony import */ var _components_days_list__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/days-list */ "./src/components/days-list.js");
...
/* harmony import */ var _point_list__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./point-list */ "./src/controllers/point-list.js");
/* harmony import */ var _components_message_no_points__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/message-no-points */ "./src/components/message-no-points.js");
...
class TripController {
  constructor(container, tripTotalCostElement, tripInfoContainerElement, filterContainerElement, onDataChange) {
    ...
    this._daysListComponent = new _components_days_list__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._tripInfoComponent = new _components_trip_info__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._filterComponent = new _components_filter__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._messageNoPointsComponent = new _components_message_no_points__WEBPACK_IMPORTED_MODULE_7__["default"]();
  ...
  init(points) {
    ...
    this._pointListController = new _point_list__WEBPACK_IMPORTED_MODULE_6__["default"](this._daysListComponent.getElement(), this._points, this._onDataChange);
    ...
    if (this._points.length) {
      ...
      Object(_utils__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._sortComponent.getElement(), _utils__WEBPACK_IMPORTED_MODULE_0__["Position"].BEFOREEND);
      Object(_utils__WEBPACK_IMPORTED_MODULE_0__["render"])(this._tripInfoContainerElement, this._tripInfoComponent.getElement(), _utils__WEBPACK_IMPORTED_MODULE_0__["Position"].AFTERBEGIN);
      Object(_utils__WEBPACK_IMPORTED_MODULE_0__["render"])(this._filterContainerElement, this._filterComponent.getElement(), _utils__WEBPACK_IMPORTED_MODULE_0__["Position"].BEFOREEND);
      ...
      Object(_utils__WEBPACK_IMPORTED_MODULE_0__["render"])(this._daysListComponent.getElement(), this._messageNoPointsComponent.getElement(), _utils__WEBPACK_IMPORTED_MODULE_0__["Position"].BEFOREEND);
    }

    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._daysListComponent.getElement(), _utils__WEBPACK_IMPORTED_MODULE_0__["Position"].BEFOREEND);
  }

  update(points) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["unrender"])(this._daysListComponent.getElement());
  ...
  _appliesFilterToList(element) {
    ...
    switch (element.dataset.filterType) {
      case `everything`:
        ...
        break;
      case `future`:
        const filteredPointsByFuture = this._points.filter(({dates}) => dates.start > moment__WEBPACK_IMPORTED_MODULE_5___default()());
        ...
        break;
      case `past`:
        const filteredPointsByPast = this._points.filter(({dates}) => dates.start < moment__WEBPACK_IMPORTED_MODULE_5___default()());
  ...
  _getUniqueCities() {
    return Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getUniqueList"])(this._points.map((point) => point.city));
  }
  ...
  _getTripInfoDates() {
    return `${moment__WEBPACK_IMPORTED_MODULE_5___default()(this._points[0].dates.start).format(`MMM DD`)} — ${moment__WEBPACK_IMPORTED_MODULE_5___default()(this._pointsSortedByEndDate[0].dates.end).format(`DD MMM`)}`;
  }
  ...
  _removeMessageNoPoints() {
    if (this._daysListComponent.getElement().contains(this._messageNoPointsComponent.getElement())) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_0__["unrender"])(this._messageNoPointsComponent.getElement());
...
/* harmony import */ var _controllers_stats__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./controllers/stats */ "./src/controllers/stats.js");
/* harmony import */ var _controllers_trip__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./controllers/trip */ "./src/controllers/trip.js");
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./api */ "./src/api.js");
/* harmony import */ var _controllers_abstract_point__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./controllers/abstract-point */ "./src/controllers/abstract-point.js");
...
const tripController = new _controllers_trip__WEBPACK_IMPORTED_MODULE_3__["default"](siteTripEventsElement, siteTotalCostElement, siteTripInfoElement, siteTripControlsElement, onDataChange);
const statsController = new _controllers_stats__WEBPACK_IMPORTED_MODULE_2__["default"](sitePageMainContainerElement);

api.getDestinations()
  .then((destinations) => _controllers_abstract_point__WEBPACK_IMPORTED_MODULE_5__["default"].setDestinations(destinations))
  .then(() => api.getOffers()
    .then((offers) => _controllers_abstract_point__WEBPACK_IMPORTED_MODULE_5__["default"].setOffers(offers)))
  .then(() => api.getPoints()
    .then((points) => {
...
const menu = new _components_menu__WEBPACK_IMPORTED_MODULE_1__["default"]();
Object(_utils__WEBPACK_IMPORTED_MODULE_0__["render"])(siteTripControlsElement, menu.getElement(), _utils__WEBPACK_IMPORTED_MODULE_0__["Position"].AFTERBEGIN);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ModelPoint; });
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_0__);
...
class ModelPoint {
  constructor(data) {
    ...
    this.duration = moment__WEBPACK_IMPORTED_MODULE_0___default()(this.dates.end).diff(moment__WEBPACK_IMPORTED_MODULE_0___default()(this.dates.start));
...
/*!**********************!*\
  !*** ./src/utils.js ***!
  \**********************/
/*! exports provided: Position, Key, groupToType, getPreposition, getUniqueList, formatDuration, createElement, render, unrender */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "groupToType", function() { return groupToType; });
...
const formatDuration = (duration) => {
  ...
  const durationBreakByUnit = {
    day: setFormatUnitTime(moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(duration).days()),
    hours: setFormatUnitTime(moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(duration).hours()),
    minutes: setFormatUnitTime(moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(duration).minutes())
  };
